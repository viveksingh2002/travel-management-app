                ...
                <div className="h-full px-3 py-4 ">
                    ...
                    <ul className="border-t mt-4 pt-4 border-gray-300 dark:border-gray-700">
                        <li>
                            <Link
                                to="/"
                                className="flex items-center rounded-xl text-gray-700 dark:text-gray-300 hover:-translate-y-1 hover:scale-105 hover:bg-red-500 dark:hover:bg-red-900 px-5 py-3"
                            >
